...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.drawScore = function (ctx) {
	  ...
	  ctx.fillText(Game.SCORE, 120, 25);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Frog.prototype.jumpScore = function (displace) {
	  ...
	  console.log(Frog.JUMP_COUNTER, Frog.JUMP_SCORE);
	  game.updateScore(points);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fly = function (options) {
	  this.dim = [80, 60];
	  this.vel = [0, 0];
	  this.pos = [40 + (160 * Math.floor(Math.random() * 5)), 60];
	  this.game = options.game;
	...
	Fly.prototype.draw = function (ctx) {
	  ...
	  if (time === game.updateTimer()) {
	    fly.show = true;
	  } else if ((time + 100) < game.updateTimer()) {
	    fly.show = false;
	  }
