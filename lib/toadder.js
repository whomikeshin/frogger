...
document.addEventListener("DOMContentLoaded", function(){
  ...
  startScreen.onload = function() {
    ...
    links.forEach(function(link) {
      ...
      ctx.fillText(link.text, link.xPos, link.yPos);
    });
  };
  ...
  canvasEl.addEventListener("click", function(event){
    var game = new Game();
    var button = { yPos: 430, xPos: 200, xDim: 400, yDim: 60 };
...
links.push(
  { url: "http://michaelkshin.com", text: "michaelkshin.com", xPos: 50, yPos: 680, yDim: 20 },
  { url: "http://github.com/whomikeshin", text: "github/whomikeshin", xPos: 300, yPos: 680, yDim: 20 },
  { url: "https://www.linkedin.com/in/mikekshin", text: "linkedin/mikekshin", xPos: 550, yPos: 680, yDim: 20 }
);
